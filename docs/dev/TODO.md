...
[] CONTINUE: connect the promptResults to /configs/installation.js, add a final review for the user that so they an see all settings at once and edit any of them, then confirm to run the installer.
